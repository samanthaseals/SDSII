...
```{r, echo = FALSE}
ggsave("/Volumes/GoogleDrive/My Drive/IAIA - SDSII/SDSII/lectures/images/w1l3fig1.png")
```
...
```{r, echo = FALSE}
ggsave("/Volumes/GoogleDrive/My Drive/IAIA - SDSII/SDSII/lectures/images/w1l3fig2.png")
```
...
```{r, echo = FALSE}
ggsave("/Volumes/GoogleDrive/My Drive/IAIA - SDSII/SDSII/lectures/images/w1l3fig3.png")
```
