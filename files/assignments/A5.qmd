...
6c. Synthesis: What is the difference between ordinal and multinomial logistic regressions? When would you choose one over the other?

<!-- your answer below here -->

<!-- your answer above here -->

6d. Re-fit `m2` using ordinal logistic regression and examine relevant statistical inference. Assume $\alpha=0.05$. How different are the results?
...
6e. Check the assumptions on ordinal logistic regression. Remember to draw a conclusion.
...
6f. If you were choosing between ordinal logistic regression and multinomial logistic regression -- which one would you choose? For full credit, you must clearly justify your choice.
