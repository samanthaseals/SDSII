...
```{r}
#| fig-align: 'center'
#| fig-alt: 'Residuals vs Fitted Values Plot for Model m1'
m1 %>% variance_check()
```
...
```{r}
#| fig-align: 'center'
#| fig-alt: 'Residuals vs Fitted Values Plot for Model m2'
m2 %>% variance_check()
```
...
```{r}
#| fig-align: 'center'
#| fig-alt: 'Residuals vs Fitted Values Plot for Model m3'
m3 %>% variance_check()
```
...
```{r}
#| fig-align: 'center'
#| fig-alt: 'Residuals vs Fitted Values Plot for Model m4'
m4 %>% variance_check()
```
...
```{r}
#| fig-align: 'center'
#| fig-alt: 'Residuals vs Fitted Values Plot for Model m5'
m5 %>% variance_check()
```    
...
```{r}
#| fig-align: 'center'
#| fig-alt: 'Residuals vs Fitted Values Plot for Model m6'
m6 %>% variance_check()
```   
...
```{r}
#| fig-align: 'center'
#| fig-alt: 'Q-Q Plot and Histogram of Residuals for Model m1'
m1 %>% normality_check()
```
...
```{r}
#| fig-align: 'center'
#| fig-alt: 'Q-Q Plot and Histogram of Residuals for Model m2'
m2 %>% normality_check()
```
...
```{r}
#| fig-align: 'center'
#| fig-alt: 'Q-Q Plot and Histogram of Residuals for Model m3'
m3 %>% normality_check()
```
...
```{r}
#| fig-align: 'center'
#| fig-alt: 'Q-Q Plot and Histogram of Residuals for Model m4'
m4 %>% normality_check()
```
...
```{r}
#| fig-align: 'center'
#| fig-alt: 'Q-Q Plot and Histogram of Residuals for Model m5'
m5 %>% normality_check()
```
...
```{r}
#| fig-align: 'center'
#| fig-alt: 'Q-Q Plot and Histogram of Residuals for Model m6'
m6 %>% normality_check()
```
...
```{r}
#| fig-align: 'center'
#| fig-alt: 'Comprehensive Regression Diagnostic Plots for Model m1'
m1 %>% reg_check()
```
...
```{r}
#| fig-align: 'center'
#| fig-alt: 'Comprehensive Regression Diagnostic Plots for Model m3'
m3 %>% reg_check()
```
...
```{r}
#| fig-align: 'center'
#| fig-alt: 'Comprehensive Regression Diagnostic Plots for Model m5'
m5 %>% reg_check()
```
