...
#| echo: false
#| fig-align: 'center'
#| fig-alt: "Empty ggplot object, labels and tickmarks present on x and y axes."
clubhouse %>% ggplot(aes(x = time_with_friends,
                         y = clubhouse_happiness))
```
...
#| echo: false
#| fig-align: 'center'
#| fig-alt: "Scatterplot showing relationship between time spent with friends (x) and clubhouse happiness (y)."
clubhouse %>% ggplot(aes(x = time_with_friends,
                         y = clubhouse_happiness)) +
  geom_point()
```
...
#| echo: false
#| fig-align: 'center'
#| fig-alt: "Scatterplot with connected points showing time spent with friends (x) and clubhouse happiness (y)."
clubhouse %>% ggplot(aes(x = time_with_friends,
                         y = clubhouse_happiness)) +
  geom_point() + 
  geom_line()
...
#| echo: false
#| fig-align: 'center'
#| fig-alt: "Scatterplot showing relationship between time spent with friends (x) and clubhouse happiness (y) with a regression line overlaid."
clubhouse %>% ggplot(aes(x = time_with_friends,
                         y = clubhouse_happiness)) +
  geom_point() + 
  geom_line(aes(y = predicted_happiness_k1)) +
...
#| echo: false
#| fig-align: 'center'
#| fig-alt: "Scatterplot showing clubhouse happiness (y) increasing as time spent with friends (x) increases."
...
#| echo: false
#| fig-align: 'center'
#| fig-alt: "Scatterplot showing clubhouse happiness (y) increasing as time spent with friends (x) increases with three regression lines overlaid."
...
#| echo: false
#| fig-align: 'center'
#| fig-alt: "Scatterplot showing clubhouse happiness (y) decreasing as the number of Donald grumbles (x) increases."
clubhouse %>% ggplot(aes(x = donald_grumbles,
                         y = clubhouse_happiness)) +
  geom_point(color = "#009CDE", size = 3) + 
  geom_line(aes(y = predicted_happiness_d), color = "#004C97", size = 1.5) +
